...
function create_dataset_structure_class_features(params)
  ...
  %%
  outFilename = sprintf(consts.structureFeaturesDataset, params.regionSrc, params.seg.featureSet, params.stage);
  % outFilename = sprintf('%s\b\b\b\b_size%d.mat', sprintf(consts.structureFeaturesDataset, params.regionSrc, params.seg.featureSet, params.stage), length(consts.useNdx));
