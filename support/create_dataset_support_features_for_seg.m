function create_dataset_support_features_for_seg(params, stage)
  Consts;
  ...
  for ii = 1 : consts.numImages
    ...
    dummyParams = params;
    dummyParams.stage = dummyParams.stage - 1;
    imgRegionsActual = get_regions(ii, dummyParams);
    ...
    [features, supporteeIds, supporterIds] = ...
        load_support_features(ii, params, imgRegionsActual);
