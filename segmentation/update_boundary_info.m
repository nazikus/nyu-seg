function [boundaryInfo2, err] = update_boundary_info(boundaryInfo, result, im, ii, stage)
  ...
  [edges, juncts, neighbors, imgRegions] = seg2fragments(imgRegions, im, 1, 3, ii, stage);  % ii and stage are passed for debug only
